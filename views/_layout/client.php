...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="ftco-blocks-cover-1">
      <div class="ftco-cover-1 overlay" style="background-image: url('public/client/images/hero_1.jpg')">
        <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            ...
            <div class="nonloop-block-13 owl-carousel">
              <div class="item-1">
                <a href="#"><img src="public/client/images/img_1.jpg" alt="Image" class="img-fluid"></a>
              ...
              <div class="item-1">
                <a href="#"><img src="public/client/images/img_2.jpg" alt="Image" class="img-fluid"></a>
                <div class="item-1-contents">
                  <div class="text-center">
                  <h3><a href="#">Range Rover S64 Coupe</a></h3>
                  <div class="rating">
    ...
    <div class="site-section section-3" style="background-image: url('public/client/images/hero_2.jpg');">
      <div class="container">
        <div class="row">
