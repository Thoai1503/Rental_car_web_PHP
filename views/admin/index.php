...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.querySelectorAll(".delete-btn").forEach(button => {
            button.addEventListener("click", function() {
                ...
                itemId; // Hiển thị trong modal
                document.getElementsByClassName("save-btn")[0].href +=
                itemId; // Set href cho nút Delete
            });
        });
    ...
    fetch('admin/updateCarStatus', {
        ...
        .then(response => response.text()) // Đọc thô thay vì response.json()
        .then(text => {
